...
public class Onlinebankingsystem{
    private static Map<String, Accounts> accounts = new HashMap<>();
    ...
    private static void createAccount() {
        ...
        Accounts account = new Accounts(accountType, initialBalance);
    ...
    private static void viewBalance() {
        System.out.print("Enter your name: ");
        String name = scanner.next();
        Accounts account = accounts.get(name);
        if (account != null) {
    ...
    private static void fundsTransfer() {
        ...
        Accounts senderAccount = accounts.get(senderName);

        System.out.print("Enter recipient's name: ");
        String recipientName = scanner.next();
        Accounts recipientAccount = accounts.get(recipientName);
